// filepath: c:\Code\McComms\src\tests\McComms.Sockets.Tests\IntegrationTests.cs
...
public class IntegrationTests
{
    ...
    private IPAddress LoopbackAddress = IPAddress.Parse("127.0.0.1");
    ...
    public void ClientServer_MultipleClients_AllReceiveResponses()
    {
        ...
        var client1 = new CommsClientSockets(LoopbackAddress, testPort);
        var client2 = new CommsClientSockets(LoopbackAddress, testPort);
