...
public class IntegrationTests
{
    ...
    //     var server = new CommsServerGrpc(Host, testPort);
    ...
    //     var client1 = new CommsClientGrpc(Host, testPort);
    //     var client2 = new CommsClientGrpc(Host, testPort);
    ...
    //         try
    //         {
    //             var client = new CommsClientGrpc(Host, testPort);
